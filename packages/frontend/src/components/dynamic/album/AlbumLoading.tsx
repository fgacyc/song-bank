  ...
  return (
    <div className="flex flex-col gap-5 p-5 pb-[70px] sm:pb-5">
      ...
      <div className="flex flex-col gap-5 md:flex-row">
        ...
        <div className="grid h-fit w-full gap-5 md:grid-cols-1 lg:grid-cols-2">
          {Array(4)
            .fill(null)
            .map((_, i) => {
              return (
                <div
                  key={i}
                  className="flex h-fit gap-5 truncate rounded-lg border-2 p-5 lg:flex-col xl:flex-row"
                >
